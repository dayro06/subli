...
<div class='text-center'><a href = "registrar_usuario.php" class='btn btn-success btn-lg rounded-pill'><i class = "fa fa-user-plus"></i>
			...
			<div class="col-5">
				<form action = "buscar_usuario.php" method = "get" class="form ml-3">   <!--form--inline -->
                       <div class="input-group input-group-xl">
                          <input class="form-control form-control-navbar" name = "busqueda" type="search" placeholder="BUSCAR..." aria-label="Search">
...
<div class="container-fluid">
				<div class="row">
						<div div class="col">
							<div class="table-responsive"> 
								<table id="tabla_usuarios" class="table table-striped table-bordered table-condensed" style = "width: 120%">
				...
				//Con esta sentencia sql mueestro los datos en la tabla 				
					 ...
					 <!-----------------------------------Diseño_Paginador----------------------------------------->
	                  <!-------------------------------------------------------------------------------------------->
						 ...
						 <nav>
							 ...
							 if($pagina != 1){
							 ?>
							    <li class="page-item"><a href="?pagina=<?php echo 1 ; ?>"  class="page-link"><span>|<</span></a></li>
							    <li class="page-item"><a href="?pagina=<?php echo $pagina - 1 ; ?>"  class="page-link"><span>Anterior</span></a></li>
						    <?php 
							    }
							...
							?>	
									    <li class="page-item"><a href="?pagina=<?php echo $pagina + 1 ; ?>"   class="page-link"><span>Siguiente</span></a></li>
									    <li class="page-item"><a href="?pagina=<?php echo $total_paginas; ?>" class="page-link"><span>>|</span></a></li>
